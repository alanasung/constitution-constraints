...
This note situates **Constraint Checks for Multi-Rule Constitutions** against the mentor-linked literature for
[Constraint Checks for Multi-Rule Constitutions](https://github.com/alanasung/constitution-constraints).

## Positioning

Encode constitution-like rules as constraints and measure multi-dimensional compliance on local models.

The design hypothesis is: Encode constitution-like rules as constraints and measure multi-dimensional compliance on local models.
