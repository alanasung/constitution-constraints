"""Experiment stages for Constraint Checks for Multi-Rule Constitutions."""
...
from .constit._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Constraint Checks for Multi-Rule Constitutions", "claims_gated": True})
