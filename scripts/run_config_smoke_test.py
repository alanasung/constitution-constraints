...
def _compose(preset: str | None, overrides: list[str]):
    from constit.configs.loader import load_config
...
def _smoke_one(preset: str | None, args: argparse.Namespace) -> int:
    from constit.configs.loader import save_resolved_config
    from constit.utils.git import git_state
...
def main(argv: list[str] | None = None) -> int:
    ...
    from constit.configs.loader import available_presets
